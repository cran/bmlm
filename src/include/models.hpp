...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        vector_d u_ab(static_cast<Eigen::VectorXd::Index>(J));
        (void) u_ab;  // dummy to suppress unused var warning
        ...
        stan::math::fill(u_ab,DUMMY_VAR__);
        ...
        try {
            ...
            stan::math::assign(ab, ((a * b) + covab));
            stan::math::assign(c, ((cp + (a * b)) + covab));
            stan::math::assign(pme, (ab / c));
            for (int j = 1; j <= J; ++j) {
                ...
                stan::math::assign(get_base1_lhs(u_ab,j,"u_ab",1), ((a + get_base1(U,j,3,"U",1)) * (b + get_base1(U,j,2,"U",1))));
                stan::math::assign(get_base1_lhs(u_cp,j,"u_cp",1), (cp + get_base1(U,j,1,"U",1)));
                stan::math::assign(get_base1_lhs(u_c,j,"u_c",1), (get_base1(u_cp,j,"u_cp",1) + get_base1(u_ab,j,"u_ab",1)));
                stan::math::assign(get_base1_lhs(u_pme,j,"u_pme",1), (get_base1(u_ab,j,"u_ab",1) / get_base1(u_c,j,"u_c",1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "u_ab" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
