...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(20, 4, "restart", "model_bmlm");
    ...
    reader.add_event(25, 8, "restart", "model_bmlm");
    ...
    reader.add_event(42, 11, "restart", "model_bmlm");
    reader.add_event(45, 14, "include", "/chunks/transformed_parameters.stan");
    reader.add_event(45, 0, "start", "/chunks/transformed_parameters.stan");
    reader.add_event(48, 3, "end", "/chunks/transformed_parameters.stan");
    reader.add_event(48, 15, "restart", "model_bmlm");
    reader.add_event(50, 17, "include", "/chunks/model.stan");
    reader.add_event(50, 0, "start", "/chunks/model.stan");
    reader.add_event(77, 27, "end", "/chunks/model.stan");
    reader.add_event(77, 18, "restart", "model_bmlm");
    reader.add_event(82, 23, "include", "/chunks/generated_quantities.stan");
    reader.add_event(82, 0, "start", "/chunks/generated_quantities.stan");
    reader.add_event(134, 52, "end", "/chunks/generated_quantities.stan");
    reader.add_event(134, 24, "restart", "model_bmlm");
    reader.add_event(137, 25, "end", "model_bmlm");
    return reader;
}
#include <stan_meta_header.hpp>
class model_bmlm
  : public stan::model::model_base_crtp<model_bmlm> {
private:
        int N;
        int J;
        std::vector<int> id;
...
typedef model_bmlm_namespace::model_bmlm stan_model;
#ifndef USING_R
